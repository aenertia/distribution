...
post_makeinstall_target() {
  ...
  # system manager timeout overrides (vendor defaults — user can override via /storage/.config/system.conf.d/)
  mkdir -p ${INSTALL}/usr/lib/systemd/system.conf.d
  cp -PR ${PKG_DIR}/config/system.conf.d/* ${INSTALL}/usr/lib/systemd/system.conf.d/
